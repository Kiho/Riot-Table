...
var Rtable = (function (_super) {
    ...
    Rtable.prototype._convertOpts = function (opt, noStripBlank) {
        if (!opt) {
            return;
        }
        ;
    ...
    Rtable.prototype._mergeOptions = function (obj1, obj2) {
        var obj3 = {};
        this._copyTo(obj1, obj3);
        this._copyTo(obj2, obj3);
        return obj3;
    };
    Rtable.prototype._copyTo = function (obj1, obj2) {
    ...
    Rtable.prototype._deepCopy1 = function (obj) {
    ...
    Rtable.prototype._deepCopy = function (obj) {
